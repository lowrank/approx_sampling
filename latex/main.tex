...
\begin{figure}[H]
  ...
  \caption{Pointwise residuals $f(x)-u_\theta(x)$ and sampling-point
           histograms at budget 128.  Top section: MMNN.  Bottom section:
           MLP.  Within each section algorithms are sorted by $L^2$ error.
           Blue/orange histograms show where each method allocated its 128
           samples.}
