...
\begin{figure}[H]
  ...
  \caption{Top: test function.  Bottom: $L^2$ error vs.\ budget for all
           17 algorithms.  Learnable methods achieve errors 25$\times$ lower
           than uniform/Chebyshev by concentrating samples in the two spikes.}
  \label{fig:spike_bg}
\end{figure}
