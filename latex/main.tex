...
\begin{figure}[H]
  ...
  \caption{MMNN (rank 15, width 1000) — pointwise residuals and sampling
           histograms at budget 128.}
  \label{fig:spike_bg_mmnn}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{figures/spike_bg_MLP.pdf}
  \caption{MLP ($[32,32,32,32]$, $\tanh$) — pointwise residuals and sampling
           histograms at budget 128.}
  \label{fig:spike_bg_mlp}
\end{figure}
