...
\begin{figure}[H]
  ...
  \caption{MMNN (rank 15, width 1000) — mean residual $\pm 1\sigma$ over
           20 random seeds, group 1/2 (best 6 algorithms).}
...
\begin{figure}[H]
  ...
  \caption{MMNN — group 2/2 (remaining 6 algorithms).  Learnable methods
           outperform fixed grids on average but with higher variance.}
